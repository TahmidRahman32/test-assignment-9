               ...
               return <div className='flex justify-center w-full '>
                  <div className='border-2 border-white p-6 w-full drop-shadow-md'>
                     ...
                     <div className='flex space-x-4'>
                        <p className='text-gray-500'><small className='flex items-center'> <MapPinIcon className="h-6 w-5 " />{address}</small></p>
                        <p className='text-gray-500'><small className='flex items-center'><CurrencyDollarIcon className="h-6 w-5 " />Salary: {salary}</small></p>
                     </div>

                     <Link to={`/details/${id}`}> <button
                        className='bg-indigo-400 text-white px-7 py-2 rounded-md mt-4'>View Details
                     </button>
                     </Link>
                  </div>
